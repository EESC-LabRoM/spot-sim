...
# ==================== VLM ====================
VLM_MODEL_PATH = "./models/Qwen3-VL-4B-Instruct"  # Caminho para o modelo VLM
VLM_INFERENCE_INTERVAL = 50  # Steps entre inferências (↑ = mais rápido, ↓ = mais preciso)
...
CONTROL_EVERY_N_STEPS = 50  # Steps entre comandos de braço (100 steps = 1 segundo @ 100Hz)
